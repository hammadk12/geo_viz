...
const Inisghts = () => {
  return (
    <div className='font-walsheim'>
        ...
        <li className='ml-4'>TATA brought in $9.7 million in annual sales with over 500,000 orders in 2023.</li>
        ...
        <li className='ml-4'>Africa and South America experienced a 10% growth in 2023 but have remained volatile.</li>
